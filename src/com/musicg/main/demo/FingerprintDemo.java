...
public class FingerprintDemo {
	...
	public static void main(final String[] args) {
		...
		final String filename = "cock_a_1.wav";

		// create a wave object
		final Wave wave = new Wave("audio_work/" + filename);
		...
		final byte[] loadedFp = fingerprintManager.getFingerprintFromFile("out/" + filename + ".fingerprint");
